...
export function saveCityToLs(cityData) {
    ...
    if (!localStorage.getItem('cities')) {
        cities = [];
    } else if (JSON.parse(localStorage.getItem('cities')).find((item) => item.lon === cityData.lon)) {
...
export function deleteCityFromLs(cityId) {
    ...
    if (JSON.parse(localStorage.getItem('cities')).find((item) => item.id === cityId)) {
        const savedCity = JSON.parse(localStorage.getItem('cities')).find((item) => item.id === cityId);
