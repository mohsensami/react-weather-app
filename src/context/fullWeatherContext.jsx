...
export function FullWeatherProvider(props) {
    const [fullWeather, dispatch2] = useReducer(fullWeatherReducer, initialWeather);
    ...
    return (
        <fullWeatherContext.Provider value={fullWeatherValue}>
            <FWDispatchContext.Provider value={dispValue}>{props.children}</FWDispatchContext.Provider>
